# -*- coding: utf-8 -*-
"""
Created on Sat Feb 12 22:00:12 2022
...
#creates a connection object and file called orders.db
conn = sqlite3.connect('orders.db')

#creates db within the ram only; useful for testing purposes
#conn = sqlite3.connect(:memory:)

#creates a cursor which allows us to run SQL queries against db
cur = conn.cursor()
...
#convention to add user if storing user as var
cur.execute("INSERT INTO users VALUES(?, ?, ?, ?);", user)
conn.commit()

more_users = [('00003', 'Peter', 'Parker', 'Male'), ('00004', 'Bruce', 'Wayne', 'male')]

#use execute many for list of multiple additions
...
cur.execute("SELECT * FROM users;")
three_results = cur.fetchmany(3) #param is amount selecting
print(three_results)
...
print(cur.fetchall()) #data minus deleted info
